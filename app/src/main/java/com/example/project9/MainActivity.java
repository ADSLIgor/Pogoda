            ...
            public void run() {
                switch (value) {
                    ...
                    case "11n": imageView.setImageDrawable(getResources().getDrawable(R.drawable.icon7));
                        break;
                    case "13d": imageView.setImageDrawable(getResources().getDrawable(R.drawable.icon8));
                        break;
                    case "13n": imageView.setImageDrawable(getResources().getDrawable(R.drawable.icon8));
                        break;
                    case "50d": imageView.setImageDrawable(getResources().getDrawable(R.drawable.icon9));
                        break;
                    case "50n": imageView.setImageDrawable(getResources().getDrawable(R.drawable.icon9));
                        break;
                    default:
